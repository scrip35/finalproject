...
(function ($) {
	...
	$('[data-countdown]').each(function () {
		...
		$this.countdown(finalDate, function (event) {
			$this.html(event.strftime('<span class="ht-count days"><span class="count-inner"><span class="time-count">%-D</span> <p>Дней</p></span></span> <span class="ht-count hour"><span class="count-inner"><span class="time-count">%-H</span> <p>Часа</p></span></span> <span class="ht-count minutes"><span class="count-inner"><span class="time-count">%M</span> <p>Минут</p></span></span> <span class="ht-count second"><span class="count-inner"><span class="time-count">%S</span> <p>Секунд</p></span></span>'));
		});
	});
